...
|4		|	|アプリが起動 or アクティブ状態になった	|登場時セリフを一定時間表示のち非表示	|
|5		|	|キャラクターがクリックされた	|タッチ時セリフを一定時間表示のち非表示	|
...
|13		|	|アプリが起動 or アクティブ状態になった	|登場時アニメーションを一定時間表示のち通常時アニメーション再生	|
|14		|	|キャラクターがクリックされた	|タッチ時アニメーションを一定時間表示のち通常時アニメーション再生	|
